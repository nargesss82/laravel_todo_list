...
@section('content')
    <div class="container mx-auto p-4">
        <div class="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
            ...
            <form id="userForm" class="space-y-4" action="{{route('users.store')}}" method="POST">
                @csrf
                <div class="mb-4">
                    ...
                    @enderror
                    <input type="text" id="name" name="name" class="w-full px-4 py-2 border rounded-lg" value="{{old('name')}}" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <span class="text-red-600 font-bold">{{$message}}</span>
                    @enderror
                    <input type="password" id="password_confirmation" name="password_confirmation" class="w-full px-4 py-2 border rounded-lg" value="{{old('password')}}" required>
                </div>
